...
/// Optional App Store artwork loader for the Apps card.
///
...
/// selected Apple TV; this class only resolves artwork for a known bundle ID.
@MainActor
    ...
    private func fetchArtwork(bundleID: String) async -> NSImage? {
        ...
        do {
            ...
            guard let imageHTTPResponse = imageResponse as? HTTPURLResponse,
                  (200..<300).contains(imageHTTPResponse.statusCode) else {
                return nil
            }
