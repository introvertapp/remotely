...
grep -q '<string>1.2.11</string>' Resources/Info.plist || fail "v1.2.11 bundle version missing"
awk '/<key>CFBundleVersion<\/key>/{getline; if ($0 ~ /<string>18<\/string>/) found=1} END{exit found ? 0 : 1}' Resources/Info.plist || fail "v1.2.11 build number 18 missing"
